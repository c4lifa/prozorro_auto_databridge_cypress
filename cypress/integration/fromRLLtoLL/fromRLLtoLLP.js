        ...
        cy.request({
            ...
            cy.request({
                ...
                cy.request({
                    ...
                    body = res.body;
                    body.sellingMethod = 'legitimatePropertyLease-priorityEnglish-fast';
                    body.auctionPeriod = {
                    ...
                    body.relatedOrganizations.currentTenant = {
                        "identifier": {
                            "scheme": "UA-IPN-FOP",
                            "legalName": {
                                "uk_UA": "sqwewqetring",
                        ...
                        "currentContractTime": {},
                        "representativeInfo": "qwewqe"
                    }
                    body.relatedOrganizations.currentTenant.currentContractTime.dateFrom = moment(new Date()).add(1, "minute");
                    body.relatedOrganizations.currentTenant.currentContractTime.dateTill = moment(body.relatedOrganizations.currentTenant.currentContractTime.dateFrom).add(5, "seconds");
                    body.currentTenantGuaranteeFee = {
                        "currency": "UAH",
                        "amount": 435
                    }
